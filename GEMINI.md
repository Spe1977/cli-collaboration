...
Even if Gemini CLI is the only CLI on this project, maintain `AGENT_HANDOFF.md`. It is project memory between sessions, not just a coordination artifact between different agents.
